/*---------------------------------------------------------------------------------
-----------------该段代码由代码生成器（CodeBuilder）自动生成-----------------------
-----------------作者：豆豆------------------------------------------------------
-----------------QQ：267637638----------------------------------
-----------------时间：2014/7/11 20:29:34--------------------------------------
----------------------------------------------------------------------------------*/
...
namespace JN.Data
{
    ...
    {
       //private static string server = ConfigurationSettings.AppSettings["server"].Trim();
       //private static string database = ConfigurationSettings.AppSettings["database"].Trim();
       //private static string uid = ConfigurationSettings.AppSettings["uid"].Trim();
       //private static string pwd = ConfigurationSettings.AppSettings["pwd"].Trim();

        private static readonly string connectionString = ConfigurationSettings.AppSettings["ConnectionStringOtherSystems"].Trim();//"server=" + server + ";database=" + database + ";uid=" + uid + ";pwd=" + pwd;
