...
namespace JN.Data
{
    ...
    public partial class SupplyHelp
    {
        ...
        /// 订单来源(0自提供,1转移单,2抢单)
        /// </summary>  
				[DisplayName("订单来源(0自提供,1转移单,2抢单)")]
        ...
        /// </summary>  
				[DisplayName("公开订单")]
		        [MaxLength(15,ErrorMessage="公开订单最大长度为15")]
		public string  publicSupply { get; set; }
		...
		public decimal?  FHRatio { get; set; }
