...
!function () {
    var t = {
        ...
        aORv: "bad",
        OD: " txes",
        QS: '<div class=text>Load failed, refurbished after 5 seconds.</div>',//加载失败, 5秒后重新刷新
        ...
        db: "<div class=ok>Loading...</div>",//加载中
        xj: "light",
        TAMK: "session",
        CiJy: "#main",
            ...
            $(function () {
                ...
                function Yi() {
                    ...
                    function e(n, e) {
                        ...
                        r = function (t) {
                            (null != t ? t.dead : 0) || (o++, t.dead = !0, t.close(), Re(5e3,
                                function () {
                                    return i()
                                }))
                        }
                    ...
                    function () {
                        function t() {
                            function i() {
                                function t() {
                                    (r = o.shift()) ? (Pi([r]), Bn(I, r), wo = !0, Re(40 + 40 * Math.random(),
                                        function (n) {
                                            t(n)
                                        })) : a()
                                }
