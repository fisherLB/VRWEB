...
namespace JN.Services.Tool
{
    /// <summary>
    /// 访问钱包服务器api帮助类
    /// 要求在web.config 中设置 appSettings 节点
    /// 
    /// 
    /// </summary>
    public class OmnicoreHelper
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static ReturnResult<string> CreateNewAddress(string apihost, string name, string callbackUrl = "")
        {
       ...
       /// <returns></returns>
        ...
        /// </param>
        /// <returns></returns>
        public static ReturnResult<List<JN.Data.Extensions.ResponseListUSDTTransactions>> GetListTransactions(string apihost, string account)
        {
            ...
            var result = client.Post(url, dic).FromJson<ReturnResult<List<JN.Data.Extensions.ResponseListUSDTTransactions>>>();
